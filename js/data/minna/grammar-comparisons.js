/**
 * grammar-comparisons.js — Grammar Pattern Comparisons
 * Side-by-side comparisons of commonly confused grammar patterns
 */
window.QuizApp = window.QuizApp || {};
window.QuizApp.grammarComparisons = (function () {
  "use strict";
   ...
   * - vietnamese: Vietnamese title
   * - patterns: Array of pattern strings being compared
   * - table: Comparison table with headers and rows
   * - tips: Overall tips for distinguishing patterns
  ...
  /**
   * Get all comparisons
   * @returns {Array} All comparison objects
   */
   ...
   * @returns {Array} Filtered comparisons
   */
  function getComparisonsByJLPT(level) {
   ...
   * @returns {Array} Filtered comparisons
   */
  function getComparisonsByDifficulty(difficulty) {
    return COMPARISONS.filter(c => c.difficulty === difficulty);
  }

  /**
   * Search comparisons by pattern
   * @param {string} pattern - Pattern string to search for
   * @returns {Array} Comparisons containing the pattern
   */
  function getComparisonsByPattern(pattern) {
  ...
  return {
    ...
    getAllComparisons,
    getComparisonById,
    getComparisonsByJLPT,
    getComparisonsByDifficulty,
    getComparisonsByPattern
  };
})();
