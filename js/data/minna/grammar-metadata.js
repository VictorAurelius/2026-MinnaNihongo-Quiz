/**
 * grammar-metadata.js — Grammar Pattern Metadata
 * Contains tips, mnemonics, categories, and relationships for grammar patterns
 */
window.QuizApp = window.QuizApp || {};
window.QuizApp.grammarMetadata = (function () {
  "use strict";
   ...
   * @param {string} pattern - Grammar pattern string
   * @returns {Object|null} Metadata object or null
   */
  function getMetadata(pattern) {
   ...
   * @returns {Array} Array of pattern strings
   */
  function getPatternsByFunction(functionId) {
    const patterns = [];
    for (const [pattern, meta] of Object.entries(PATTERN_METADATA)) {
   ...
   * @returns {Array} Array of pattern strings
   */
  function getPatternsByJLPT(level) {
    const patterns = [];
    for (const [pattern, meta] of Object.entries(PATTERN_METADATA)) {
