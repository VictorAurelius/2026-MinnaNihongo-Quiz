...
|---|---------|--------|------|------|--------|
| 1 | App Architecture (v2 current) | [source/architecture-v2.mmd](source/architecture-v2.mmd) | Mermaid | Pre-wave | [x] |
| 2 | Route Map | [source/route-map.mmd](source/route-map.mmd) | Mermaid | Pre-wave | [x] |
| 3 | Component Hierarchy | [source/component-tree.mmd](source/component-tree.mmd) | Mermaid | Pre-wave | [x] |
| 4 | Data Store Flow | [source/store-flow.mmd](source/store-flow.mmd) | Mermaid | Pre-wave | [x] |
