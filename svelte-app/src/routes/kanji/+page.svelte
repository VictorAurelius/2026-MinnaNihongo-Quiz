    ...
    <div class="flex flex-col gap-3">
      {#each lessons as lesson}
        <a
          ...
          class="flex items-center gap-4 w-full px-5 py-4.5 bg-card rounded-xl shadow-sm text-left no-underline transition-all duration-150 hover:shadow-md hover:-translate-y-0.5 active:scale-[0.98] cursor-pointer group"
        >
